...
class Example(Frame):
    ...
    def createListBoxRides(self, frame):
        ...
        tree.column("# 2", anchor=CENTER, minwidth=0, width=40, stretch=NO)
    ...
    def initUI(self):
        ...
        label_ether_img = self.getImage(cost_frame, "/eth_ico.ico", (32, 32))  # TODO - MAKE RELATIVE PATH
        # PACK
